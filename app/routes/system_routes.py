...
@system_bp.route('/api/system/uptime')
@login_required
def get_uptime():
...
@system_bp.route('/api/system/cleanup_models', methods=['POST'])
@login_required
def cleanup_models():
    """Cleanup old models."""
    try:
...
@system_bp.route('/api/background_worker/status')
@login_required
...
@system_bp.route('/api/background-status', methods=['GET'])
